...
import { apiClient, LeadCaptureRequest, SaveCaseRequest } from '../lib/api';
...
const FloatingChatbot: React.FC<FloatingChatbotProps> = ({ isVisible, onClose, onCaseCreated }) => {
    ...
    try {
      ...
      if (response.completed) {
        ...
        if (isAuthenticated && user) {
          try {
            const saveCaseRequest: SaveCaseRequest = {
            ...
            const saveResponse = await apiClient.saveCase(saveCaseRequest);
            console.log('Case saved successfully:', saveResponse);
            
            // Notify parent component about case creation
            if (onCaseCreated) {
              onCaseCreated(saveResponse.case_id);
            }
            
            // Store case ID in localStorage for dashboard access
            localStorage.setItem('currentCaseId', saveResponse.case_id);
            
            // Auto-generate documents for the case
            try {
              const documentsResponse = await apiClient.autoGenerateDocuments(saveResponse.case_id, user.id);
              console.log('Documents generated successfully:', documentsResponse);
              
              handleAddBotMessage(
                `🎉 Excellent! I've gathered all the information needed for your claim and saved it to your account. Your case ID is ${saveResponse.case_id}. I've also generated your claim packet and demand letter. To access these documents and continue with your case, you'll need to subscribe to our service.`,
                [
              ...
              handleAddBotMessage(
                `🎉 Excellent! I've gathered all the information needed for your claim and saved it to your account. Your case ID is ${saveResponse.case_id}. To access your personalized claim packet and continue with your case, you'll need to subscribe to our service.`,
                [
                  { label: "Subscribe to Get Started", value: "subscribe" },
                  { label: "Learn More About Pricing", value: "pricing" }
                ]
          ...
          // User not authenticated, show subscription requirement
          handleAddBotMessage(
            "🎉 Excellent! I've gathered all the information needed for your claim. To access your personalized claim packet and continue with your case, you'll need to subscribe to our service.",
            [
              { label: "Subscribe to Get Started", value: "subscribe" },
    ...
    try {
      ...
      if (isAuthenticated && user) {
        try {
          ...
          const saveResponse = await apiClient.saveCase(saveCaseRequest);
          console.log('Case saved successfully (skipped):', saveResponse);
          ...
          try {
            const documentsResponse = await apiClient.autoGenerateDocuments(saveResponse.case_id, user.id);
            console.log('Documents generated successfully (skipped):', documentsResponse);
            
            handleAddBotMessage(
              `No problem! I've generated your basic claim packet and demand letter with the information you've provided and saved it to your account. Your case ID is ${saveResponse.case_id}. To access these documents and continue with your case, you'll need to subscribe to our service.`,
              [
                { label: "Subscribe to Get Started", value: "subscribe" },
                { label: "Learn More About Pricing", value: "pricing" }
              ]
            ...
            console.error('Error generating documents (skipped):', docError);
            handleAddBotMessage(
              `No problem! I've generated your basic claim packet with the information you've provided and saved it to your account. Your case ID is ${saveResponse.case_id}. To access your claim packet and continue with your case, you'll need to subscribe to our service.`,
              [
                { label: "Subscribe to Get Started", value: "subscribe" },
                { label: "Learn More About Pricing", value: "pricing" }
              ]
          ...
          console.error('Error saving case (skipped):', error);
          handleAddBotMessage(
