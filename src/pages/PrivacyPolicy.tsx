            ...
            >
              <div className="text-center">
                <div className="inline-flex items-center gap-2 mb-6">
                  <MailIcon className="h-6 w-6 text-[#8dff2d]" />
                ...
                <div className="text-gray-200 font-normal space-y-1">
                  ...
                  <p className="mt-4">
                    <span className="text-gray-400">Privacy inquiries: </span>
                    <a href="mailto:privacy@docupilot.com" className="text-[#8dff2d] hover:text-[#7be525] transition-colors">
                      privacy@docupilot.com
                    </a>
                  </p>
                </div>
              </div>
