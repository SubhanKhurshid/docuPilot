              ...
              <div className="text-center max-w-4xl mx-auto">
                ...
                >
                  ...
                  >
                    <button
                      onClick={() => {
                        // This will be handled by the floating chatbot
                        const chatButton = document.querySelector('[data-chat-trigger]') as HTMLElement;
                        if (chatButton) chatButton.click();
                      }}
                      className="group inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 rounded-full border border-[#8dff2d] text-[#8dff2d] font-semibold text-base sm:text-lg hover:bg-[#8dff2d] hover:text-black transition-all duration-300 w-full sm:w-auto sm:min-w-[200px] md:min-w-[220px]"
                    >
